...
const sampleMediaContent: MediaContentCollection = {
  ...
  image: {
    src: 'https://images.unsplash.com/photo-1540747913346-19e32dc3e97e?q=80&w=1280&auto=format&fit=crop',
    background:
      'https://images.unsplash.com/photo-1542281286-9e0a16bb7366?q=80&w=1920&auto=format&fit=crop',
    title: 'CricAI Ultimate Experience',
    date: 'Live Stats Engine',
    scrollToExpand: 'Scroll to Expand Demo',
    about: {
      overview:
        'This is a demonstration of the ScrollExpandMedia component with a custom cricket-themed image. The same smooth expansion effect works beautifully with static images, allowing you to create engaging visual experiences without video content.',
      conclusion:
